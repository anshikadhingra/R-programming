...
#Project/Case Study:
# Read CSV data file
mydata = read.csv("C:/Users/mayan/SkillEdge/Analytics/R programs/R codes/Analytics_Edge_R/data/MBA.csv")
...
# aggregated data
rules1 = apriori(dt2, parameter=list(support=0.05, confidence=0.8, minlen = 2))
rules1
summary(rules1)
inspect(rules1[1:5])
...
View(rules4)
write(rules4, "C:/Users/mayan/SkillEdge/Analytics/R programs/R codes/Analytics_Edge_R/rules2.csv", sep=",")
