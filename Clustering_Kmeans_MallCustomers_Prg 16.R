...
customer_data=read.csv("C:/Users/mayan/SkillEdge/Analytics/R programs/R codes/Analytics_Edge_R/data/Mall_Customers.csv",header = T)
str(customer_data)
names(customer_data)
View(customer_data)
...
#creating barplot or piechart to show  gender distribution across our customer_data dataset.
